  ...
  return (
    <div className="min-h-screen p-3 sm:p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6 sm:mb-8">Movie Categories</h1>
                ...
                <CardContent className="p-4 sm:p-6 flex items-center justify-between relative">
                  <div className="flex items-center gap-3 sm:gap-4 overflow-hidden">
                    ...
                    <div className="overflow-hidden">
                      ...
                      <p className="text-xs text-cyan-200">Latest 30 movies</p>
                    </div>
                  </div>
