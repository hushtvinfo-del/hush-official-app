      ...
      <div className="max-w-7xl mx-auto">
        ...
        {totalFavorites === 0 && !isLoading ? (
          ...
          <Tabs defaultValue="channels" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-gray-800/50 border-orange-500/30">
              <TabsTrigger value="channels" className="data-[state=active]:bg-orange-600 data-[state=active]:text-white">
                <Tv className="w-4 h-4 mr-2" />
                Channels ({favoriteChannels?.length || 0})
              </TabsTrigger>
              <TabsTrigger value="movies" className="data-[state=active]:bg-orange-600 data-[state=active]:text-white">
                <Film className="w-4 h-4 mr-2" />
                Movies ({favoriteMovies?.length || 0})
              </TabsTrigger>
              <TabsTrigger value="series" className="data-[state=active]:bg-orange-600 data-[state=active]:text-white">
              ...
              {favoriteChannels?.length === 0 ? (
                <Card className="bg-gray-800/50 backdrop-blur-xl border-orange-500/30">
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    <Tv className="w-12 h-12 text-orange-400 mb-3" />
                          ...
                          <Card className="bg-gray-800/50 backdrop-blur-xl border-orange-500/30 hover:border-orange-500/60 transition-all cursor-pointer group overflow-hidden h-full flex flex-col">
                            <CardContent className="p-3 relative flex-grow flex flex-col">
                              <div className="aspect-video bg-gray-900/50 rounded-md mb-3 flex items-center justify-center overflow-hidden relative">
                                ...
                                <div style={{ display: 'none', position: 'absolute', inset: 0, alignItems: 'center', justifyContent: 'center' }}><Tv className="w-8 h-8 text-orange-400" /></div>
                                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center"><div className="w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center"><Play className="w-6 h-6 text-white ml-1" /></div></div>
                              </div>
            ...
            <TabsContent value="movies" className="mt-6">
              {favoriteMovies?.length === 0 ? (
                <Card className="bg-gray-800/50 backdrop-blur-xl border-orange-500/30">
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    <Film className="w-12 h-12 text-orange-400 mb-3" />
                        ...
                        <Card className="bg-gray-800/50 backdrop-blur-xl border-orange-500/30 hover:border-orange-500/60 transition-all cursor-pointer group overflow-hidden h-full flex flex-col">
                          <CardContent className="p-3 relative flex-grow flex flex-col">
                            <div className="aspect-[2/3] bg-gray-900/50 rounded-md mb-3 flex items-center justify-center overflow-hidden relative">
                              ...
                              <div style={{ display: 'none', position: 'absolute', inset: 0, alignItems: 'center', justifyContent: 'center' }}><Film className="w-12 h-12 text-orange-400" /></div>
                              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center"><div className="w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center"><Play className="w-6 h-6 text-white ml-1" /></div></div>
                            </div>
            ...
            <TabsContent value="series" className="mt-6">
              {favoriteSeries?.length === 0 ? (
                <Card className="bg-gray-800/50 backdrop-blur-xl border-orange-500/30">
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    <Clapperboard className="w-12 h-12 text-orange-400 mb-3" />
                        ...
                        <Card className="bg-gray-800/50 backdrop-blur-xl border-orange-500/30 hover:border-orange-500/60 transition-all cursor-pointer group overflow-hidden h-full flex flex-col">
                          <CardContent className="p-3 relative flex-grow flex flex-col">
                            <div className="aspect-[2/3] bg-gray-900/50 rounded-md mb-3 flex items-center justify-center overflow-hidden relative">
                              ...
                              <div style={{ display: 'none', position: 'absolute', inset: 0, alignItems: 'center', justifyContent: 'center' }}><Clapperboard className="w-12 h-12 text-orange-400" /></div>
                            </div>
